  ...
  return (
    <Form onSubmit={sendEmail} id="contactForm">
      <Form.Group controlId="name">
        ...
        <Form.Control required name="name" placeholder="Your name goes here." onBlur={handleChange} />
      </Form.Group>

      <Form.Group controlId="email">
        <Form.Label>Your Email</Form.Label>
        <Form.Control required name="email" type="email" placeholder="youremail@email.com"  onBlur={handleChange} />
      </Form.Group>
